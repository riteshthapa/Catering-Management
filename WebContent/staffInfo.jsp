...
<div class="bg-img_staff">
	<div class="form_container">
 		<form class="text-center border border-light p-5" action="staffInfo.jsp">

		<p class="h4 mb-4">KNOW YOUR STAFF</p>

		  <p>GET THE STAFF INFO BY PROVIDING COMPANY ID</p>
		
		  <!-- Name -->
		  <input type="text" id="defaultSubscriptionFormPassword" name="co_id" class="form-control mb-4" placeholder="enter company ID">
...
String sql ="SELECT * FROM staffs where company_id = '" + co_id + "'";
