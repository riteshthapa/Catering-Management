...
<div class="bg-img_menu">
	<div class="form_container">
 		<form class="text-center border border-light p-5" action="#!">

		  <p class="h4 mb-4">CATERER MENU</p>
		
		  <p>FIND OFFERED MENU BASED ON COMPANY NAME</p>
		
		  <!-- Name -->
		  <input type="text" id="defaultSubscriptionFormPassword" name="co_name" class="form-control mb-4" placeholder="Chipotle">
	...
	<div class="table">
		...
		String sql 
		="SELECT caterer.company_name, menu.menu_item FROM caterer INNER JOIN menu ON caterer.ID = menu.company_id WHERE caterer.company_name= '" + co_name + "'";
